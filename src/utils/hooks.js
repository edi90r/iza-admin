...
export const useAppView = () => {
    ...
    useEffect(() => {
        const routesPattern = [
            ...
            {
                pattern: '/add-user/personal-data',
                view: 'addUserPersonalData',
            },
            {
                pattern: '/add-user/contact-data',
                view: 'addUserContactData',
            },
            {
                pattern: '/add-user/register',
                view: 'addUserRegister',
            },
            {
                pattern: '/add-user/summary',
                view: 'addUserSummary',
            },
            {
                pattern: '/user-details/:id/edit',
                view: 'editUser',
            },
            {
                pattern: '/user-details/:id/edit-credentials',
